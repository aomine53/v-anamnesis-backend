...
import com.vanammesis.patientservice.external.services.PrescriptionServiceImpl;
...
public class PatientController {
    ...
    public List<Prescription> getAllPrescriptionByPatient(@PathVariable("patientId") long patientId){
